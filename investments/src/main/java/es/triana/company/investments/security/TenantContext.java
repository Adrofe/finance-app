package es.triana.company.investments.security;
...
/**
 * Extracts tenant_id from the authenticated JWT token (Keycloak).
 * This component is used to enforce proper tenant isolation in the Investments module.
 */
@Component
